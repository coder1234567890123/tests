<template>
  <div
    id="app"
    class="container">
    <h1 class="title mb-3">My Profile</h1>
    <v-card>
        ...
        <v-layout
          ...
          <v-flex
            ...
            <v-layout
              ...
              <v-flex md3><label class="right py-3"><strong>Company</strong></label></v-flex>
              <v-flex md8>
                <v-text-field
...
export default {
  ...
  mounted() {
    this.$store.dispatch('user/getMe', this.$route.params.id)
  },
  methods: {
    resetPassword() {
